...
import com.example.eatitv2shipper.callback.IshippingOrderCallbackListener;
...
public class HomeViewModel extends ViewModel implements IshippingOrderCallbackListener {
    ...
    public void loadOrderByShipper(String shipperPhone){
        ...
        DatabaseReference shipperRef = FirebaseDatabase.getInstance().getReference(Common.SHIPPER_ORDER_REF);
