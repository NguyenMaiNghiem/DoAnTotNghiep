...
import com.example.eatitv2server.Callback.IBestDealsCallbackListener;
...
public class BestDealsViewModel extends ViewModel implements IBestDealsCallbackListener {
    ...
    public void loadBestDeals() {
        ...
        DatabaseReference bestDealsRef = FirebaseDatabase.getInstance().getReference(Common.BEST_DEALS);
