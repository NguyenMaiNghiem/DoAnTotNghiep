package com.example.eatitv2server.ui.order;

import android.Manifest;
import com.example.eatitv2server.EventBus.PrintOrderEvent;
...
import com.example.eatitv2server.Adapter.MyOrderAdapter;
import com.example.eatitv2server.Adapter.MyShipperSelectedAdapter;
import com.example.eatitv2server.Callback.IShipperLoadCallbackListener;
import com.example.eatitv2server.Common.BottomSheetOrderFragment;
import com.example.eatitv2server.Common.Common;
import com.example.eatitv2server.Common.MySwipeHelper;
import com.example.eatitv2server.EventBus.ChangeMenuClick;
import com.example.eatitv2server.EventBus.LoadOrderEvent;
import com.example.eatitv2server.Model.FCMSendData;
...
import com.example.eatitv2server.Model.TokenModel;
import com.example.eatitv2server.R;
import com.example.eatitv2server.remote.IFCMService;
import com.example.eatitv2server.remote.RetrofitFCMClient;
