...
import com.example.eatitv2server.Callback.ISingleShippingOrderCallbackListener;
import com.example.eatitv2server.Common.Common;
import com.example.eatitv2server.Model.ShippingOrder;
import com.example.eatitv2server.remote.IGoogleAPI;
import com.example.eatitv2server.remote.RetrofitGoogleAPIClient;
...
public class TrackingOrderActivity extends FragmentActivity implements OnMapReadyCallback, ISingleShippingOrderCallbackListener, ValueEventListener {
        ...
        FirebaseDatabase.getInstance()
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                      ...
                      {
                         ShippingOrder shippingOrderModel = dataSnapshot.getValue(ShippingOrder.class);
    ...
    @Override
    public void onSingleShippingOrderLoadSuccess(ShippingOrder shippingOrderModel) {
    ...
    private void subscribeShipperMove(ShippingOrder shippingOrderModel) {
    ...
    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
        ...
        if(dataSnapshot.exists())
        {
            ...
            String from = new StringBuilder()
                    ...
                    .append(",")
                    .append(currentShippingOrder.getCurrentLng()).toString();
