...
@Entity(tableName = "Cart", primaryKeys ={"uid","categoryId", "foodId", "foodAddon", "foodSize","milkteaId"})
public class CartItem {

    @NonNull
    @ColumnInfo(name = "milkteaId")
    ...
    public void setMilkteaId(@NonNull String milkteaId) {
