...
import com.example.eatitv2client.Adapter.MyOrdersAdapter;
import com.example.eatitv2client.Callback.ILoadOrderCallbackListener;
...
import com.example.eatitv2client.Model.ShippingOrderModel;
import com.example.eatitv2client.R;
import com.example.eatitv2client.TrackingOrderActivity;
...
public class ViewOrdersFragment extends Fragment implements ILoadOrderCallbackListener {
    ...
    private void loadOrdersFromFirebase() {
        ...
        FirebaseDatabase.getInstance("https://eatit-baff2-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference(Common.ORDER_REF)
                .orderByChild("userId")
