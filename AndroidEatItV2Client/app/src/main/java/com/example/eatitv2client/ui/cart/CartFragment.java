...
import com.example.eatitv2client.Adapter.MyCartAdapter;
import com.example.eatitv2client.Callback.ILoadTimeFromFirebaseListener;
import com.example.eatitv2client.Callback.ISearchCategoryCallbackListener;
import com.example.eatitv2client.Common.Common;
import com.example.eatitv2client.Common.MySwipeHelper;
...
import com.example.eatitv2client.EventBus.CounterCartEvent;
import com.example.eatitv2client.EventBus.HideFABCart;
import com.example.eatitv2client.EventBus.MenuItemBack;
import com.example.eatitv2client.EventBus.UpdateItemInCart;
import com.example.eatitv2client.Model.AddonModel;
import com.example.eatitv2client.Model.CategoryModel;
import com.example.eatitv2client.Model.FCMSendData;
import com.example.eatitv2client.Model.FoodModel;
import com.example.eatitv2client.Model.OrderModel;
import com.example.eatitv2client.Model.SizeModel;
import com.example.eatitv2client.R;
import com.example.eatitv2client.Remote.IFCMService;
import com.example.eatitv2client.Remote.RetrofitFCMClient;
...
//                                    writeOrderToFirebase(order);
    ...
    private void  syncLocalTimeWithGlobalTime(OrderModel order) {
        final DatabaseReference offsetRef =
                FirebaseDatabase.getInstance("https://eatit-baff2-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference(".info/serverTimeOffset");
    ...
    private void writeOrderToFirebase(OrderModel order) {
        FirebaseDatabase.getInstance("https://eatit-baff2-default-rtdb.asia-southeast1.firebasedatabase.app/")
