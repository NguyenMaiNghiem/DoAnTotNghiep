package com.example.eatitv2client.ui.home;

import androidx.annotation.NonNull;
import androidx.lifecycle.MutableLiveData;
import androidx.lifecycle.ViewModel;

import com.example.eatitv2client.Callback.IBestDealCallbackListener;
import com.example.eatitv2client.Callback.IPopularCallbackListener;
import com.example.eatitv2client.Common.Common;
import com.example.eatitv2client.Model.BestDealModel;
import com.example.eatitv2client.Model.PopularCategoryModel;
...
public class HomeViewModel extends ViewModel implements IPopularCallbackListener, IBestDealCallbackListener {
   ...
   private IBestDealCallbackListener bestDealCallbackListener;
    ...
    private void loadBestDealList() {
        ...
        DatabaseReference bestDealRef = FirebaseDatabase.getInstance("https://eatit-baff2-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference(Common.BEST_DEALS_REF);
    ...
    private void loadPopularList() {
        ...
        DatabaseReference popularRef = FirebaseDatabase.getInstance("https://eatit-baff2-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference(Common.POPULAR_CATEGORY_REF);
