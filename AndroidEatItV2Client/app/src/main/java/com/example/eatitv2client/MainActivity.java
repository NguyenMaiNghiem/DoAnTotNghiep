...
import com.example.eatitv2client.Remote.ICloudFunctions;
import com.example.eatitv2client.Remote.RetroFitCloudClient;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        userRef = FirebaseDatabase.getInstance("https://eatit-baff2-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference(Common.USER_REFERENCES);
