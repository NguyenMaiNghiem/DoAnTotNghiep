package com.example.eatitv2client.ui.menu;

import androidx.annotation.NonNull;
import androidx.lifecycle.MutableLiveData;
import androidx.lifecycle.ViewModel;

import com.example.eatitv2client.Callback.ICategoryCallbackListener;
...
public class MenuViewModel extends ViewModel implements ICategoryCallbackListener {
    ...
    public void loadCategories() {
        ...
        DatabaseReference categoryRef = FirebaseDatabase.getInstance("https://eatit-baff2-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference(Common.CATEGORY_REF);
